...
// //         <form className='w-[90%] h-[600px] max-w-[500px] bg-[#00000062] backdrop-blur  shadow-lg shadow-black flex flex-col items-center 
// //         justify-center gap-[20px] px-[20px]'onSubmit={handleSignIn} >
// //             <h1 className='text-white text-[30px] font-semibold mb-[30px]'>Sign In to 
// //                 <span className='text-blue-400'>AI Virtual Assistant</span></h1>
...
// //          outline-none border-2 border-white  bg-transparent text-white rounded-full text-[18px] relative'>
